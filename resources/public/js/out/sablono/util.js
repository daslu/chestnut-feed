...
sablono.util.ToString = (function (){var obj24837 = {};
return obj24837;
})();
...
return (function (){var or__12655__auto__ = (sablono.util.to_str[goog.typeOf(x__13299__auto__)]);
if(or__12655__auto__){
return or__12655__auto__;
} else {
var or__12655__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj24839 = {};
return obj24839;
})();
...
var x__13299__auto__ = (((x == null))?null:x);
return (function (){var or__12655__auto__ = (sablono.util.to_uri[goog.typeOf(x__13299__auto__)]);
if(or__12655__auto__){
return or__12655__auto__;
} else {
var or__12655__auto____$1 = (sablono.util.to_uri["_"]);
if(or__12655__auto____$1){
return or__12655__auto____$1;
} else {
...
as_str.cljs$lang$applyTo = (function (arglist__24840){
var xs = cljs.core.seq(arglist__24840);
...
var vec__24842 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__24842,(0),null);
var words = cljs.core.nthnext.call(null,vec__24842,(1));
...
var G__24844 = clojure.set.rename_keys.call(null,m,kmap);
var G__24844__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__24844,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__24844);
return G__24844__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__24845_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__24845_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24845_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__24845_SHARP_)){
return p1__24845_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24845_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__24846){
var maps = cljs.core.seq(arglist__24846);
...
var vec__24850 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__24850,(0),null);
var names = cljs.core.nth.call(null,vec__24850,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__24850,tag_name,names){
return (function (p1__24847_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__24847_SHARP_));
});})(matches,vec__24850,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__24850,tag_name,names){
return (function (p1__24848_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__24848_SHARP_));
});})(matches,vec__24850,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__24851){
var vec__24854 = p__24851;
var tag = cljs.core.nth.call(null,vec__24854,(0),null);
var content = cljs.core.nthnext.call(null,vec__24854,(1));
...
var vec__24855 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__24855,(0),null);
var id = cljs.core.nth.call(null,vec__24855,(1),null);
var class$ = cljs.core.nth.call(null,vec__24855,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__12655__auto__ = x__$1.hasDomain();
